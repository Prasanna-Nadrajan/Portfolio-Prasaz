...
export const projects: Project[] = [
  {
    ...
    link: "https://github.com/Prasanna-Nadrajan/AI-Driven-Land-Use-and-Land-Cover-Classification-",
    description:
      "Implemented an ensemble learning model to classify land use and land cover (LULC) from satellite imagery, achieving high accuracy in identifying various land types.",
    techStack: ["Python", "Scikit-learn", "TensorFlow", "Satellite Imagery"],
  ...
  },
  {
    ...
    description:
      "Developed a Smart Traffic Management System using Computer Vision to detect emergency vehicles in real-time through visual and audio cues. Implemented virtual environment with automated traffic light control.",
  ...
  },
  {
    ...
    category: "Python",
    image:
      "/assets/images/portfolio/ai-powered-code-reviewer-for-ml-pipelines.png",
    link: "https://github.com/Prasanna-Nadrajan/AI-powered-code-review-for-ML-pipelines",
    description:
      "Automated code review tool for ML pipelines analyzing best practices and performance bottlenecks.",
  ...
  },
  {
    ...
    description:
      "Streamlit application predicting loan eligibility using financial and personal data.",
  ...
  },
  {
    ...
    link: "",
    description:
      "A visually stunning space exploration website built with React and Three.js, featuring interactive 3D models of planets and space missions.",
  ...
  },
  {
    ...
    description:
      "A full-featured event management system with user registration, event scheduling, and real-time notifications.",
  ...
  },
  {
    ...
    description:
      "A comprehensive retail management system with inventory, sales, and customer management features.",
  ...
  },
  {
    ...
    description:
      "A mini OTT platform built with React, featuring movies and TV shows.",
  ...
  },
  {
    ...
    description:
      "A modern, responsive portfolio website built with React and Tailwind CSS, featuring dark mode, animations, and a clean UI.",
  ...
  },
  {
    ...
    description:
      "CGI-based system with payment processing, customer management, and history tracking.",
