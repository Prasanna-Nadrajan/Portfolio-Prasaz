...
const Platforms = () => {
  ...
  return (
    <article className="platforms active animate-fade-in" data-page="platforms">
      <SEO
        title="Platforms"
        description="Check out my profiles on various coding platforms."
      />
      <header>
      ...
      <section className="mb-10 flex flex-col md:flex-row gap-6">
        ...
        <ProjectCard
          ...
          image="/assets/images/linked_in.jpg"
      ...
      <section className="platforms-list">
        <h3 className="h3 service-title text-xl font-semibold mb-6">
          Coding Profiles
        </h3>
          ...
          {platforms.map((platform, index) => (
            ...
            >
              <div className="platform-icon bg-onyx p-3 rounded-xl shadow-neon shrink-0">
                ...
                />
                <div className="hidden w-10 h-10 bg-jet rounded-lg flex items-center justify-center text-xs text-secondary-text">
                  IMG
                </div>
              </div>

              <div className="platform-content">
                <h3 className="text-main-text text-lg font-medium mb-1">
                  {platform.title}
                </h3>
